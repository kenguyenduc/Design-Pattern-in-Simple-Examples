...
import VD2.ShapeFactory.ShapeType;
...
public class DrawingClient extends JFrame {
    ...
    public DrawingClient(int width, int height) {
        ...
        startButton.addActionListener((ActionEvent event) -> {
            ...
            for (int i = 0; i < 20; ++i) {
                Shape shape1 = ShapeFactory.getShape(getRandomShape());
                shape1.draw(g, getRandomX(), getRandomY(), getRandomWidth(), getRandomHeight(), getRandomColor());
            }
        });
    }
